...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  /* link para o regulamento completo */
  .reg-jump{ text-align:center; margin-top:22px; }
  .reg-jump a{
    color:var(--cyan); font-size:13px; text-decoration:none; font-weight:600;
    border-bottom:1px dotted var(--cyan); padding-bottom:2px;
  }
  .reg-jump a:hover{ color:#fff; border-color:#fff; }

  /* regulamento na integra */
  .reg-wrap{ max-width:820px; margin:70px auto 0; padding:0 20px; }
  .reg-head{ text-align:center; margin-bottom:26px; }
  .reg-head .eyebrow{ margin-bottom:8px; }
  .reg-head h2{
    font-family:'Barlow Condensed',sans-serif; font-weight:800; text-transform:uppercase;
    font-size:clamp(26px,5vw,38px); margin:0 0 8px; letter-spacing:.01em;
  }
  .reg-head p{ color:var(--slate); font-size:14px; max-width:520px; margin:0 auto; line-height:1.6; }
  ...
  .chapter summary .arrow{ color:var(--amber); font-family:'Inter',sans-serif; font-size:14px; transition: transform .2s ease; flex:0 0 auto; }
  .chapter[open] summary .arrow{ transform: rotate(90deg); }
  .chapter-body{ padding:4px 22px 20px; }
  .article-block{ margin-bottom:16px; }
  .article-num{
    font-weight:700; color:var(--cyan); font-size:14px; display:block; margin-bottom:3px;
  }
  .article-text{ font-size:14.5px; line-height:1.65; color:#dde2f5; }
  .article-text .paragrafo{ display:block; margin-top:6px; padding-left:14px; color:#c3cae8; font-size:14px; }
  .anexo-note{
...
<div class="wrap">
  ...
  <div class="reg-jump"><a href="#regulamento-completo">↓ Ver o regulamento completo, artigo por artigo</a></div>
</div>

<div class="reg-wrap" id="regulamento-completo">
  <div class="reg-head">
    <div class="eyebrow">Documento oficial</div>
    <h2>Regulamento na íntegra</h2>
  ...
  <details class="chapter">
    ...
    <div class="chapter-body">
      ...
      <div class="article-block"><span class="article-num">Art. 9º</span><span class="article-text">A definição da ordem de participação das candidaturas nas Sabatinas será realizada por meio de sorteio formal, durante reunião com as campanhas regularmente convocadas.
        ...
        <span class="paragrafo">§ 4º Mediante solicitação oficial da campanha interessada, a gravação do sorteio poderá ser disponibilizada pela Salvador FM, preferencialmente em formato digital, em até 2 (dois) dias úteis após o recebimento da solicitação.</span>
        <span class="paragrafo">§ 5º O cronograma oficial das Sabatinas será divulgado às campanhas após a realização do sorteio, por meio dos canais oficiais de comunicação previamente informados por cada campanha.</span>
  ...
  <details class="chapter">
    ...
    <div class="chapter-body">
      <div class="article-block"><span class="article-text">O cronograma oficial das Sabatinas Eleitorais será elaborado e divulgado pela Salvador FM, contendo, no mínimo: I - programa em que será realizada a Sabatina; II - data; III - horário de início da transmissão; IV - horário de chegada da candidatura; V - candidatura participante; VI - ordem das Sabatinas; VII - demais informações operacionais que a Salvador FM considerar necessárias para a realização da Sabatina.
        <span class="paragrafo">Parágrafo único. O cronograma poderá ser atualizado pela Salvador FM em razão de fatos supervenientes, decisões judiciais, alterações legislativas ou ajustes operacionais, sendo todas as campanhas oficialmente comunicadas.</span>
      </span></div>
      <div class="article-block"><span class="article-num">Da Comunicação com as Campanhas</span><span class="article-text">As informações constantes deste Anexo, bem como quaisquer alterações, comunicados, orientações operacionais ou documentos referentes às Sabatinas, serão encaminhadas aos canais oficiais previamente informados pela campanha.
        <span class="paragrafo">§ 1º Consideram-se canais oficiais aqueles expressamente indicados pela campanha durante a reunião de apresentação das regras ou posteriormente formalizados junto à Salvador FM.</span>
        <span class="paragrafo">§ 2º As comunicações poderão ser realizadas por correio eletrônico (e-mail), WhatsApp ou outro meio oficialmente informado e aceito entre as partes.</span>
        <span class="paragrafo">§ 3º Considerar-se-á realizada a comunicação no momento do envio pela Salvador FM ao canal oficial informado pela campanha, cabendo à própria campanha acompanhar regularmente esses meios de comunicação.</span>
      </span></div>
    </div>
  </details>
  ...
  <details class="chapter">
    ...
    <div class="chapter-body">
      <div class="article-block"><span class="article-text">Os temas que integrarão a urna de sorteio serão definidos pela equipe de jornalismo da Salvador FM. Os temas poderão ser atualizados antes do início das Sabatinas, mediante comunicação oficial às campanhas participantes.
        <span class="paragrafo">Temas possíveis para sorteio: Regulação na saúde · Educação, ciência e tecnologia · Segurança pública · Geração de empregos · Infraestrutura e logística · Agropecuária · Combate à pobreza · Meio ambiente e recursos hídricos · Saneamento básico · Turismo · Cultura · Desenvolvimento regional · Esporte e lazer · Políticas para mulheres · Atração de investimentos e ambiente de negócios · Convivência com a seca no semiárido · Gestão fiscal · Conflitos por terra · Economia do mar · Energias renováveis.</span>
      </span></div>
    </div>
  </details>
  ...
  <details class="chapter">
    ...
    <div class="chapter-body">
      ...
      <p class="anexo-note">Os contatos individuais (e-mails e telefones diretos da equipe) não são exibidos nesta página pública, por se tratar de dado pessoal — estão disponíveis com a Direção do Programa mediante canal oficial.</p>
    </div>
  </details>
</div>
